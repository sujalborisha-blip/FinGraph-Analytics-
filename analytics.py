...
def main():
    ...
    # Types of fraud we injected in Week 1 and Week 2
    ...
    with open(LOG_FILE, 'r') as f:
        for line in f:
            ...
            try:
                ...
                # Check if it's a fraud transaction
    ...
    if total_tx > 0 and total_fraud_tx > 0:
        ...
        print(f"⚠️ CRITICAL ALERT: {fraud_percentage:.2f}% of all transactions are part of a money laundering syndicate!")
    elif total_tx > 0:
